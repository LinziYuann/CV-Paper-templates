...
\author{Anonymous ACCV 2020 submission}
...
The submission page length is 14 pages for content plus unlimited pages for references.
...
By submitting a manuscript to ACCV 2020, the author(s) assert that it has
...
during the ACCV 2020 review period to either a journal or a
conference. However, the manuscript may also be submitted to
one workshop that is accompanying ACCV 2020 (see Fig.~\ref{fig:ACCV20}).

\begin{figure}
\centering
\includegraphics[width=120mm]{accv20} 
\caption{
The website of ACCV 2020 is at \url{http://accv2020.kyoto}. 
...
All supplemental material must be zipped or tarred into a single file. There is a 100~MB limit on the size of this file. The deadline for supplemental material is a week after the main paper deadline.
...
cite it as
\begin{quote}
[1]  Authors: The frobnicatable foo filter, ACCV 2020 Submission ID 512,
Supplied as additional material {\tt accv20-512-frfofi.pdf}.
\end{quote}

Finally, you may feel you need to tell the reader that more details can be found elsewhere, and refer them to a technical report.  For conference submissions, the paper must stand on its own, and not {\em require} the reviewer to go to a techreport for further details.  Thus, you may say in the body of the paper ``further details may be found in~\cite{Authors20b}.''  Then submit the anonymized techreport as additional material. Again, you may not assume the reviewers will read this material.
...
ACCV 2020 full paper paper submission. 
...
Figure~\ref{fig:ACCV20} contains lettering of different sizes; in such a case make sure that the smallest letters have a height of 2~mm.
...
9-point type (Figs.~\ref{fig:ACCV20} and \ref{fig:example} show examples).
